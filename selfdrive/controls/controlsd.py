...
IGNORE_PROCESSES = {"rtshield", "uploader", "deleter", "loggerd", "logmessaged", "tombstoned",
                    ...
                    "statsd", "shutdownd","dmonitoringmodeld","dmonitoringd","navd"} | \
...
class Controls:
  def __init__(self, sm=None, pm=None, can_sock=None):
    ...
    if self.sm is None:
      ...
      self.sm = messaging.SubMaster(['deviceState', 'pandaStates', 'peripheralState', 'modelV2', 'liveCalibration', 'longitudinalPlan', 'lateralPlan', 'liveLocationKalman',
    ...
    # 获取 CarInterface CarParameter
    # self.CI = CarInterface
    # self.CP = CarParameter
    ...
    self.auto_change_lane = params.get_bool("AutoChangeLane")
  ...
  def data_sample(self):
    ...
    #
    # self.CC carControl Message car.CarControl.new_message()
    # 获取车辆控制状态
    # CS = carState
  ...
  def state_transition(self, CS):
    ...
    # SOFT DISABLING 软禁用
    #
    #控制状态不为禁用，USER_DISABLE、IMMEDIATE_DISABLE 事件出现事禁用控制。
